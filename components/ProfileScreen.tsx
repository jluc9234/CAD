...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ onPremiumClick }) => {
    ...
    return (
        <div className="pt-20 pb-24 px-4 text-white overflow-y-auto h-full scrollbar-hide">
            <div className="max-w-md mx-auto">
                <div className="grid grid-cols-3 grid-rows-3 gap-2 mb-6 aspect-square">
                    {photoGrid.map((imgSrc, i) => (
                         <div
                            key={i}
                            className={`bg-slate-800/50 border-2 border-dashed border-slate-700 rounded-xl flex items-center justify-center
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="hidden"
                            />
                            <button onClick={() => fileInputRef.current?.click()} className="w-full text-center bg-slate-700/50 hover:bg-slate-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors duration-300">
                                Choose a Photo
                            </button>
                        </div>
